...
public class GM2_CONFIG {
	...
	public static final int CELLS_ON_START=800;
     //GENERAL
    ...
    public final static int CREATE_SAVE_ON_LIFETIME=7000;
    public final static int LIMITED_ARRAY_SIZE=CELLS_ON_START/100*1;
     //NORMCELL SETTINGS
    public static final boolean MULTI_THREAD_EVALUTE_FITNESS_METHOD=false;
    public static final int NUMBER_OF_MUTATIONS=11;/*Сколько нод мутируют при делении клетки(в конструкторе)*/
    public static final int MUTATION_CHANCE=200;//rand.nextInt(MUTATION_CHANCE)==0
