...
public class FRAME_CONFIG {
	...
	public static final int CELLS_ON_START=3000;//900
	public static final int ORGANIC_ON_DAETH_RANGE=3;
	public static final int HOW_MANY_LAST_CELLS_TO_SAVE=10;//20
    //GENERAL
	public final static int WIDTH=1280;
    public final static int HEIGHT=720;
	public static final boolean AUTO_SIZE=true;
    public final static int CELL_SIZE=8;//2 
    ...
    public static final int HOW_MUCH_ORGANIC_EATS_PER_STEP=4;//3
    //Multiply energy
    ...
    //Mutations 
    public static final int MAX_NUMBER_OF_MUTATIONS=100;/*Сколько нод мутируют при делении клетки(в конструкторе)*///5
    public static final int CHANCE_OF_NODE_DEACTIVATE=50;
    public static final int CHANCE_OF_NODE_ACTIVATE=CHANCE_OF_NODE_DEACTIVATE-10;
    public static final int MUTATION_CHANCE=90;//rand.nextInt(100)<MUTATION_CHANCE 10%
