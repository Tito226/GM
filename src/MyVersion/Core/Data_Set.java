...
public class Data_Set {
    ...
    public static Double[][] getEatOrganicTrainData0() {
    	return new Double[][]{{0d,rnd(HOW_MUCH_ORGANIC_EATS_PER_STEP,ENERGY_NEEDED_TO_MULTIPLY),rnd(7,50),r.nextDouble(),r.nextDouble(),r.nextDouble(),r.nextDouble(),r.nextDouble()},
    ...
    public static Double[][] getEatOrganicTrainData() {
    	return new Double[][]{{0d,rnd(HOW_MUCH_ORGANIC_EATS_PER_STEP,ENERGY_NEEDED_TO_MULTIPLY),rnd(7,50),r.nextDouble()*DataMethods.nextOrganicValue,r.nextDouble()*DataMethods.nextOrganicValue,r.nextDouble()*DataMethods.nextOrganicValue,r.nextDouble()*DataMethods.nextOrganicValue,r.nextDouble()},
    	{(Action_Boundaries.eatOrganicBoundaries[1]+Action_Boundaries.eatOrganicBoundaries[0])/2}};
    } 
    ...
    public static Double[][] getMoveUpTrainData() {
    	return new Double[][]{{0d,rnd(3,ENERGY_NEEDED_TO_MULTIPLY),rnd(0,3),0d,0d,0d,0d,(Action_Boundaries.moveUpBoundaries[1]+Action_Boundaries.moveUpBoundaries[0])/2d},
    ...
    public static Double[][] getMoveLeftIfDownWallTrainData() {
    	return new Double[][]{{0d,rnd(4,ENERGY_NEEDED_TO_MULTIPLY),rnd(1,4),0d,1d,0d,0d,(Action_Boundaries.moveLeftBoundaries[1]+Action_Boundaries.moveLeftBoundaries[0])/2},
    ...
    public static Double[][] getMoveLeftIfDownWallTrainData2() {
    	return new Double[][]{{0d,rnd(4,ENERGY_NEEDED_TO_MULTIPLY),rnd(1,4),0d,1d,0d,0d,(Action_Boundaries.moveDownBoundaries[1]+Action_Boundaries.moveDownBoundaries[0])/2},
    	{(Action_Boundaries.moveLeftBoundaries[1]+Action_Boundaries.moveLeftBoundaries[0])/2}};
    }
    //--------------------------------------------------------------------------------------------
    //INPUTS:(isReadyToMultiply,energy,organic,upCell,downCell,leftCell,rightCell)
    public static Double[][] getMoveLeftIfFoodTrainData() {
    	return new Double[][]{{0d,rnd(4,ENERGY_NEEDED_TO_MULTIPLY),rnd(1,4),0d,0d,DataMethods.nextOrganicValue/2,0d,(r.nextDouble())},
    	{(Action_Boundaries.moveLeftBoundaries[1]+Action_Boundaries.moveLeftBoundaries[0])/2}};
    }
    public static Double[][] getMoveRightIfFoodTrainData() {
    	return new Double[][]{{0d,rnd(4,ENERGY_NEEDED_TO_MULTIPLY),rnd(1,4),0d,0d,0d,DataMethods.nextOrganicValue/2,(r.nextDouble())},
    	{(Action_Boundaries.moveRightBoundaries[1]+Action_Boundaries.moveRightBoundaries[0])/2}};
    }
    public static Double[][] getMoveUpIfFoodTrainData() {
    	return new Double[][]{{0d,rnd(4,ENERGY_NEEDED_TO_MULTIPLY),rnd(1,4),DataMethods.nextOrganicValue/2,0d,0d,0d,(r.nextDouble())},
    	{(Action_Boundaries.moveUpBoundaries[1]+Action_Boundaries.moveUpBoundaries[0])/2}};
    }
    public static Double[][] getMoveDownIfFoodTrainData() {
    	return new Double[][]{{0d,rnd(4,ENERGY_NEEDED_TO_MULTIPLY),rnd(1,4),0d,DataMethods.nextOrganicValue/2,0d,0d,0d,(r.nextDouble())},
    	{(Action_Boundaries.moveDownBoundaries[1]+Action_Boundaries.moveDownBoundaries[0])/2}};
    }
