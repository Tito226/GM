...
public class Core_Config {
    ...
    public static final double BIAS_VALUE=-0.52d;//Value of bias dots//-7 -6
    ...
    public static final double FADING=9.6/Math.pow(10,22);//0.00000000000000000000000000000007d 6/Math.pow(10,22);
