...
public class Core_Config {
    ...
    public static final double FADING=5.7/Math.pow(10,22);//0.00000000000000000000000000000007d 6/Math.pow(10,22);
    ...
    public static final int HOW_MUCH_INPUTS_MUST_BE_USED=8;//7
    ...
    public static final double MUTATION_MULTIPLIER=0.13D;/*регулирует максимальную "силу" мутации*///0.4
}
