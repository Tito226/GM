...
public class NEAT_Config implements Serializable {
    ...
    public static final int HIDDEN_NODES = 60;//20
    public static final int POPULATION =28; //3

    public static final float COMPATIBILITY_THRESHOLD = 10;//5
    ...
    public static final float STEPS = 0.03f;  //base 0.1f
    ...
    public static final float DISABLE_MUTATION_CHANCE = 0.1f;//0.4
    public static final float ENABLE_MUTATION_CHANCE = 0.2f ;//0.15
    public static final float CROSSOVER_CHANCE = 0.05f;//0.75
