...
public class NEAT_Config implements Serializable {
    ...
    public static final int POPULATION =4; //3

    public static final float COMPATIBILITY_THRESHOLD = 6;//5
    public static final float EXCESS_COEFFICENT = 2;//2
    public static final float DISJOINT_COEFFICENT = 2; //2
    public static final float WEIGHT_COEFFICENT = 0.6f; //0.4 //0.1 base
    ...
    public static final float WEIGHT_CHANCE = 0.5f; //0.3
    public static final float WEIGHT_MUTATION_CHANCE = 0.9f;
    public static final float NODE_MUTATION_CHANCE = 0.03f;//0.03
    public static final float CONNECTION_MUTATION_CHANCE = 0.05f; //0.05
    ...
    public static final float ENABLE_MUTATION_CHANCE = 0.4f ;//
