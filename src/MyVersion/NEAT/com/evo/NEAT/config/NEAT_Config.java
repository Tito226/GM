...
public class NEAT_Config implements Serializable {
    ...
    public static final int HIDDEN_NODES = 11;//20
    public static final int POPULATION =20; //3
    ...
    public static final float STALE_SPECIES = 20;
    ...
    public static final int STALE_POOL = 15 ;
}
