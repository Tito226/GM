...
public class NEAT_Config implements Serializable {
    ...
    public static final int POPULATION =38; //3
    ...
    public static final float STALE_SPECIES = 33;


    public static final float STEPS = 0.1f;  //base 0.1f
    public static final float PERTURB_CHANCE = 0.9f;//0.9
    public static final float WEIGHT_CHANCE = 0.7f ;//0.3
